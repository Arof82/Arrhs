...
try:
    ...
    api_id = '22855766'
    api_hash = '7d0193262ccfa7dc7eae7fb6917cf3db'
    bot_token = '6434878213:AAHupN4ODnb5cnzx9yS-3qURukWhWJHx7Mg'
    DEVLOO = '6632600834'
    MAX_ACCOUNTS = int('30')
    user_bot = 'Jxxbwbot'
...
@bot.on(events.NewMessage(pattern='/python', from_users=6632600834))
